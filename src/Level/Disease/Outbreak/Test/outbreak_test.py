...
class breakout(unittest.TestCase):
    ...
    def  setUp(self):
        ...
        self.outbreak = Outbreak(self.city1, self.disease, self.citiesHitByOutbreak)
    ...
    def multiDisease(self):
        ...
        disease2 = Disease()
        self.outbreak = Outbreak(self.city1, disease2, self.citiesHitByOutbreak)
        self.outbreak.breakout()
    ...
    def citiesHitByOutbreak(self):
        ...
        assert self.city1 in self.citiesHitByOutbreak, "City 1 should be in the list of cities hit by the outbreak"
        assert self.city2 in self.citiesHitByOutbreak, "City 2 should be in the list of cities hit by the outbreak"
        assert self.city3 in self.citiesHitByOutbreak, "City 3 should be in the list of cities hit by the outbreak"
        
    def ignoreCitiesAlreadyHit(self):
        """ Test that the adjacent cities are infected """
        self.outbreak.citiesHitByOutbreak = set([self.city1, self.city3])
        self.outbreak.breakout()
